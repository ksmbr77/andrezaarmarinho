    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-primary">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <span className="inline-flex items-center gap-2.5 border border-primary-foreground/30 bg-primary-foreground/10 rounded-full px-5 py-2.5 text-[11px] md:text-[12px] tracking-[0.15em] text-primary-foreground/80">
        ...
        <motion.h1
          ...
          className="font-heading text-[2.2rem] sm:text-[3rem] md:text-[5rem] lg:text-[6.5rem] font-bold leading-[1.02] mb-8 tracking-[-0.02em] text-primary-foreground"
        >
          Sua Produção
          <br />
          Começa{" "}
        ...
        >
          <a
            href="#catalogo"
            className="group inline-flex items-center justify-center gap-2.5 bg-primary-foreground text-primary rounded-full px-9 py-4 text-sm font-bold tracking-wide hover:bg-primary-foreground/90 transition-all duration-300 hover:shadow-lg hover:shadow-black/20"
          >
            Ver Catálogo
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2.5 border border-primary-foreground/40 text-primary-foreground rounded-full px-9 py-4 text-sm tracking-wide hover:border-primary-foreground/70 hover:bg-primary-foreground/10 transition-all duration-300"
          >
