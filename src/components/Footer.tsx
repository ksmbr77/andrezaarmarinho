    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        ...
        <div className="border-t border-primary-foreground/20 pt-6 sm:pt-8 flex flex-col items-center gap-4 md:flex-row md:justify-between">
          ...
          <a href="https://www.instagram.com/fly.agencyy/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-primary-foreground/70 hover:text-primary-foreground transition-colors duration-300">
